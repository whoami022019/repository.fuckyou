...
class navigator:
    ...
    def root(self):
        ...
        if self.getMenuEnabled('navi.clownspecial') == True:
            self.addDirectoryItem('[B][COLOR orange]13Clowns Specials (1 CLICKS, IPTV, MAIN EVENTS)[/COLOR][/B]', 'lists', 'tvshows.png', 'DefaultTVShows.png')
        ...
        if self.getMenuEnabled('navi.docu') == True:
            self.addDirectoryItem(32631, 'movies&url=newdocs', 'documentaries.png', 'DefaultMovies.png')
